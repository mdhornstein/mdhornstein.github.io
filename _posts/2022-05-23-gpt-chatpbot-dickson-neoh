...
# Following Dickson Neoh's guide to deploy a language model on a chatbot 

In this post, I will document my process of following Dickson Neoh's guide to deploy GPT-J in a chatbot. 
